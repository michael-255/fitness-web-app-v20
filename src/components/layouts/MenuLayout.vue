...
const { route, goToRecordsData, goToList, goBack } = useRouting()
    ...
    <QLayout view="hHh LpR lff">
        <QHeader elevated :class="`bg-${AppHeaderColor}`">
            <QToolbar>
                ...
                <QBtn v-if="route.name !== RouteName.DASHBOARD" flat round :icon="Icon.BACK" @click="goBack()" />

                <div v-else>
                    <QBtn class="q-px-sm q-mr-sm" color="accent" :icon="Icon.WORKOUTS" @click="goToList()" />
                    <QBtn
